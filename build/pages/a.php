...
<body class="m-0 font-sans text-base antialiased font-normal bg leading-default bg-gray-50 text-slate-500">
    ...
    <nav class="bg-white border-gray-200 md:px-8 shadow">
        <div class=" flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <div>
                    <button class="flex items-center text-sm rounded-full md:me-0 hover:bg-black/20 px-2 py-1"
    ...
    <form method="post" action="./userHome.php">
        <div class="mx-10 xl:mx-20 my-11 ">
            ...
            <div class="md:mx-4">
                <form action="./userDetailBarang.php" method="post">
                    <div class="flex flex-wrap w-full between px-2 xl:px-7 mb-5">
                        ...
                        <input type="text" name="namabarang" value="<?=$namabarang;?>" placeholder=""
                    ...
                    <div class="flex flex-wrap w-full px-2 xl:px-7 mb-5">
                        ...
                        <div class="flex w-full md:w-[500px]">
                            ...
                            <button type="submit" id="increment-button" data-input-counter-increment="quantity-input"
        ...
        <div class="flex flex-wrap w-full px-2 xl:px-7 mb-5">
            ...
            <input type="date" id="datepicker" name="tanggal_peminjaman"
        ...
        <div class="flex flex-wrap w-full px-2 xl:px-7 mb-5">
            ...
            <input type="date" id="datepicker" name="tanggal_pengembalian"
                class="flex border h-8 w-full md:w-[500px] pl-2 rounded-2 mt-1 p-2 border-gray-300 focus:outline-none focus:ring focus:border-blue-500" />
        </div>
        <button id="openModalButton" type="submit" name="pinjam"
